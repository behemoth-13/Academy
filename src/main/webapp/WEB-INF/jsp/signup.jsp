...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Welcome to Online Teacher Signup</h1>
				<p>Just insert your unique user name and password</p>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-6">
						<form:form id="myForm" method="post"
							class="bs-example form-horizontal" commandName="teacher">
							<fieldset>
								<legend>Teacher Signup Form</legend>
